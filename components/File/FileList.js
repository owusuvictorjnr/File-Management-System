...
function FileList() {
  ...
  return (
    <div className="bg-white mt-5 p-5 px-10 mx-5 rounded-lg">
      <h2 className="text-[1rem] font-bold">Recent Files</h2>
      <div className="grid grid-cols-4 md:grid-cols-3 text-[.8rem] font-semibold border-b-[1px] pb-2 mt-3 border-gray-300 text-gray-400">
        <h2>Name</h2>
        <div className="grid grid-cols-3 gap-[5rem] md:gap-[9rem] lg:gap-[17rem]">
          <h2>Modified</h2>
          <h2>Size</h2>
          <h2>action</h2>
        </div>
